...
- fix(Turbomole): use `$coord angs` for read @e-kwsm (#2418)
- Turbomole: support `$periodic` @e-kwsm (#2379)
- Update Conformer plots for RMSD and Energy @ghutchis (#2382)
...
- Use LC\_NUMERIC=C for AppImage run script @ghutchis (#2533)
