...
- fix(QtOpenGL): honor QT\_VERSION @e-kwsm (#2154)
...
- chore: remove ENABLE\_TRANSLATIONS that is no longer used @e-kwsm (#2077)
...
- test: enable spacegrouptest only if USE\_SPGLIB is true @e-kwsm (#2030)
- Update find\_dependency calls for Qt6 @ghutchis (#2026)
- build: bump cmake\_minimum\_required @e-kwsm (#2022)
- Migrate QTAIM and Symmetry to Qt6 @ghutchis (#1998)
- Set USE\_MMTF to OFF by default @matterhorn103 (#2005)
